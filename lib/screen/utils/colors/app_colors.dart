...
class AppColor{
  ...
  static Color screenWidget =const Color(0xff6b6b6b);


  static Color lightBgColor =const Color(0xffb1d0e0);
  static Color lightSecondaryColor =const Color(0xff406882);
  static Color lightActiveColor =const Color(0xff6998ab);
  static Color lightPrimaryColor =const Color(0xff1a374d);
  static Color darkPrimaryColor =const Color(0xffb1d0e0);
  static Color darkSecondaryColor =const Color(0xff406882);
  static Color darkActiveColor =const Color(0xff6998ab);
  static Color darkBgColor =const Color(0xff1a374d);
}
